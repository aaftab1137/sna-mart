...
<html lang="en">
   <head>
      ...
      <style>
         ...
         .container {max-width: 800px;margin: 30px auto;padding: 20px;background-color: #fff;box-shadow: 0 0 10px rgba(0,0,0,0.1);}
   ...
   <body>
      <div class="container">
         ...
         <p>We are SNA Mart ("Company," "we," "us," "our"), a company registered in India at Pune, Pune, Maharashtra 411048.</p>
         <p>We operate the website <a href="https://snamart.com">https://snamart.com</a> (the "Site"), the mobile application SNA Mart (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
         <p>You can contact us by email at <a href="mailto:support@snamart.com">support@snamart.com</a> or by mail to Pune, Pune, Maharashtra 411048, India.</p>
         <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and SNA Mart, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
         <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:updates@snamart.com">updates@snamart.com</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
         ...
         <ul>
            ...
            <li><a href="#section5">Purchases and Payment</a></li>
            <li><a href="#section6">Subscriptions</a></li>
            <li><a href="#section7">Prohibited Activities</a></li>
            <li><a href="#section8">User Generated Contributions</a></li>
            <li><a href="#section9">Contribution License</a></li>
            <li><a href="#section10">Guidelines for Reviews</a></li>
            <li><a href="#section11">Mobile Application License</a></li>
            <li><a href="#section12">Services Management</a></li>
            <li><a href="#section13">Privacy Policy</a></li>
            <li><a href="#section14">Copyright Infringements</a></li>
            <li><a href="#section15">Term and Termination</a></li>
            <li><a href="#section16">Modifications and Interruptions</a></li>
            <li><a href="#section17">Governing Law</a></li>
            <li><a href="#section18">Dispute Resolution</a></li>
            <li><a href="#section19">Corrections</a></li>
            <li><a href="#section20">Disclaimer</a></li>
            <li><a href="#section21">Limitations of Liability</a></li>
            <li><a href="#section22">Indemnification</a></li>
            <li><a href="#section23">User Data</a></li>
            <li><a href="#section24">Electronic Communications, Transactions, and Signatures</a></li>
            <li><a href="#section25">Miscellaneous</a></li>
            <li><a href="#section26">Contact Us</a></li>
         </ul>
         ...
         <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:support@snamart.com">support@snamart.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
         ...
         <h2 id="section6">6. Subscriptions</h2>
         ...
         <h2 id="section7">7. Prohibited Activities</h2>
         ...
         <h2 id="section8">8. User Generated Contributions</h2>
         ...
         <h2 id="section9">9. Contribution License</h2>
         ...
         <h2 id="section10">10. Guidelines for Reviews</h2>
         ...
         <h2 id="section11">11. Mobile Application License</h2>
         <h3>Use License</h3>
         ...
         <h2 id="section12">12. Services Management</h2>
         ...
         <h2 id="section13">13. Privacy Policy</h2>
         ...
         <h2 id="section14">14. Copyright Infringements</h2>
         ...
         <h2 id="section15">15. Term and Termination</h2>
         ...
         <h2 id="section16">16. Modifications and Interruptions</h2>
         ...
         <h2 id="section17">17. Governing Law</h2>
         <p>These Legal Terms shall be governed by and defined following the laws of India. SNA Mart and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>

         <h2 id="section18">18. Dispute Resolution</h2>
         <p>You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship established by these Legal Terms to the jurisdiction of the India courts. SNA Mart shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Legal Terms are entered into in the course of your trade or profession, the state of your principal place of business.</p>

         <h2 id="section19">19. Corrections</h2>
         ...
         <h2 id="section25">25. Miscellaneous</h2>
         ...
         <h2 id="section26">26. Contact Us</h2>
         <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
         <div class="contact-info">
            <p>SNA Mart Pune Pune,</p>
            <p>Maharashtra 411048 India</p>
            <p>Email: <a href="mailto:support@snamart.com">support@snamart.com</a></p>
         </div>
      </div>
   </body>
</html>